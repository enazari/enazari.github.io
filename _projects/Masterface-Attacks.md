...
description: Nine adversarial embeddings impersonate 47% of identities in a face verification model scoring 99.65% on benchmark — exposing the gap between pairwise accuracy and real security.
